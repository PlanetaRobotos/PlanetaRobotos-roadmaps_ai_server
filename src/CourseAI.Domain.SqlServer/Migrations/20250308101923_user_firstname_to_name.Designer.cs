...
namespace CourseAI.Domain.Migrations
{
    ...
    [Migration("20250308101923_user_firstname_to_name")]
    partial class user_firstname_to_name
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseAI.Domain.Entities.AppSumo.AppSumoLicense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppSumoLicenses", (string)null);
                });
            ...
            modelBuilder.Entity("CourseAI.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "622535ce-7b6d-41a7-8c38-c02d37e58d9b",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHWWuKDaMkAAAJTBO8uxZccHQclLso4P80+/uJg6p6kcksh8P5jEcT2oudFJ9MsoQw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6993c769-4cda-470c-89fc-d95d20c2195c",
                            Tokens = 0,
            ...
            modelBuilder.Entity("CourseAI.Domain.Entities.UserPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseAI.Domain.Entities.AppSumo.AppSumoLicense", b =>
                {
                    b.HasOne("CourseAI.Domain.Entities.Identity.User", "User")
                        .WithOne()
                        .HasForeignKey("CourseAI.Domain.Entities.AppSumo.AppSumoLicense", "UserId")
