...
namespace CourseAI.Domain.Migrations
{
    ...
    [Migration("20250111121947_categoris_default_quid_added")]
    partial class categoris_default_quid_added
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourseAI.Domain.Entities.Categories.CategoryRelation", b =>
                {
                    ...
                    b.HasIndex("ParentCategoryId", "Order");
            ...
            modelBuilder.Entity("CourseAI.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c1632975-e7e9-4a70-912a-c8b434e8cbee",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBERV3yFyq6PxqXo3h+X2gMKRTAYGZ17h+ZaSByLY8DOg8eb42m7LEIoG2gsGXlFKA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6e17b0ce-bc9b-4a85-9857-eddaee4089e1",
                            Tokens = 0,
